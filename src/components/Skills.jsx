...
export default function Skills() {
  ...
  return (
    <Reveal>
      <div id="skills" className="flex flex-col lg:flex-row min-h-[500px] bg-white px-5 md:px-12 lg:px-20 xl:px-[120px] py-[68px] md:py-[78px] gap-12 lg:gap-[78px]">
        ...
        <Reveal className="flex flex-col pt-2 pb-0 flex-1 px-0" delay={180}>
          <div className="w-fit text-[#0b3442] font-['Poppins'] text-[32px] md:text-[44px] font-semibold leading-[1.12] tracking-[-1.5px]">{t.skills.headline}</div>
          <div className="flex max-w-[560px] flex-col mt-5 mb-0 text-[#293f47] font-['Poppins'] text-[13px] leading-[1.9] mx-0">
            <div className="w-fit text-[#293f47] font-['Poppins'] text-[13px] leading-[1.9]">{t.skills.desc1}</div>
            <div className="w-fit text-[#293f47] font-['Poppins'] text-[13px] leading-[1.9] mt-2">{t.skills.desc2}</div>
          </div>
