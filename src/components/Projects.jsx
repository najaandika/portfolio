...
const projects = [
  {
    ...
    ctaText: 'View Code',
    ctaLabel: 'Open AC & Electronics Service Website source code in a new tab',
  ...
  },
  {
    ...
    ctaLabel: 'Open SaaS Dashboard UI live preview in a new tab',
    link: 'https://hub-affix-00189305.figma.site',
    image: '/images/project-saas-dashboard.webp',
  },
  {
